...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const translations = {
        pt: {
            ...
            project2Title: "Sistema Bancário Python",
            project2Desc: "Sistema bancário de console desenvolvido em Python. Apresenta uma arquitetura MVC, persistência de dados com SQLite e operações essenciais como depósito, saque e extrato.",
            /* PROJETOS REMANEJADOS */
            project3Title: "Landing Page de Restaurante",
            project3Desc: "Página de aterrissagem moderna e responsiva para um restaurante, focada na conversão e na experiência do usuário.",
            project4Title: "Calculadora de Calorias",
            project4Desc: "Ferramenta web para cálculo de consumo diário de calorias, com interface limpa e resultados instantâneos.",
            project5Title: "App de Clima",
            project5Desc: "Aplicação que consulta APIs para exibir a previsão do tempo em tempo real de qualquer cidade do mundo.",
            project6Title: "Gerador de Senhas",
            project6Desc: "Crie senhas seguras e customizáveis com esta ferramenta, ajustando comprimento e tipos de caracteres.",
            project7Title: "Calculadora IMC",
            project7Desc: "Uma calculadora simples e direta para medir o Índice de Massa Corporal, ajudando no acompanhamento da saúde.",
            project8Title: "Kanban Board",
            project8Desc: "Sistema de quadro Kanban para organização de tarefas, permitindo mover cards entre colunas de forma interativa.",
            project9Title: "Projeto Acessibilidade",
            project9Desc: "Estudo e aplicação de práticas de acessibilidade web (WCAG) para garantir que a navegação seja inclusiva para todos.",
        ...
        en: {
            ...
            project2Title: "Python Banking System",
            project2Desc: "Console banking system developed in Python. Features an MVC architecture, data persistence with SQLite, and essential operations like deposit, withdrawal, and statement.",
            /* PROJECTS RE-INDEXED */
            project3Title: "Restaurant Landing Page",
            project3Desc: "Modern and responsive landing page for a restaurant, focused on conversion and user experience.",
            project4Title: "Calorie Calculator",
            project4Desc: "Web tool for calculating daily calorie intake, with a clean interface and instant results.",
            project5Title: "Weather App",
            project5Desc: "Application that queries APIs to display the real-time weather forecast for any city in the world.",
            project6Title: "Password Generator",
            project6Desc: "Create secure and customizable passwords with this tool, adjusting length and character types.",
            project7Title: "BMI Calculator",
            project7Desc: "A simple and straightforward calculator to measure Body Mass Index, helping with health monitoring.",
            project8Title: "Kanban Board",
            project8Desc: "Kanban board system for task organization, allowing cards to be moved interactively between columns.",
            project9Title: "Accessibility Project",
            project9Desc: "Study and application of web accessibility practices (WCAG) to ensure navigation is inclusive for everyone.",
        ...
        es: {
            ...
            project2Title: "Sistema Bancario en Python",
            project2Desc: "Sistema bancario de consola desarrollado en Python. Presenta una arquitectura MVC, persistencia de datos con SQLite y operaciones esenciales como depósito, retiro y extracto.",
            /* PROYECTOS REINDEXADOS */
            project3Title: "Landing Page de Restaurante",
            project3Desc: "Página de aterrizaje moderna y responsiva para un restaurante, enfocada en la conversión y la experiencia del usuario.",
            project4Title: "Calculadora de Calorías",
            project4Desc: "Herramienta web para el cálculo del consumo diario de calorías, con una interfaz limpia y resultados instantáneos.",
            project5Title: "App del Clima",
            project5Desc: "Aplicación que consulta APIs para mostrar el pronóstico del tiempo en tiempo real de cualquier ciudad del mundo.",
            project6Title: "Generador de Contraseñas",
            project6Desc: "Crea contraseñas seguras y personalizables con esta herramienta, ajustando la longitud y los tipos de caracteres.",
            project7Title: "Calculadora de IMC",
            project7Desc: "Una calculadora simple y directa para medir el Índice de Masa Corporal, ayudando en el seguimiento de la salud.",
            project8Title: "Tablero Kanban",
            project8Desc: "Sistema de tablero Kanban para la organización de tareas, que permite mover tarjetas entre columnas de forma interactiva.",
            project9Title: "Proyecto de Accesibilidad",
            project9Desc: "Estudio y aplicación de prácticas de accesibilidad web (WCAG) para garantizar que la navegación sea inclusiva para todos.",
        ...
        fr: {
            ...
            project2Title: "Système Bancaire en Python",
            project2Desc: "Système bancaire de console développé en Python. Présente une architecture MVC, une persistance des données avec SQLite et des opérations essentielles comme le dépôt, le retrait et le relevé de compte.",
            /* PROJETS RÉINDEXÉS */
            project3Title: "Page d'Accueil de Restaurant",
            project3Desc: "Page d'accueil moderne et réactive pour un restaurant, axée sur la conversion et l'expérience utilisateur.",
            project4Title: "Calculateur de Calories",
            project4Desc: "Outil web pour le calcul de l'apport calorique quotidien, avec une interface épurée et des résultats instantanés.",
            project5Title: "Application Météo",
            project5Desc: "Application qui interroge des API pour afficher les prévisions météo en temps réel de n'importe quelle ville du monde.",
            project6Title: "Générateur de Mots de Passe",
            project6Desc: "Créez des mots de passe sécurisés et personnalisables avec cet outil, en ajustant la longueur et les types de caractères.",
            project7Title: "Calculateur d'IMC",
            project7Desc: "Un calculateur simple et direct pour mesurer l'Indice de Masse Corporelle, aidant au suivi de la santé.",
            project8Title: "Tableau Kanban",
            project8Desc: "Système de tableau Kanban pour l'organisation des tâches, permettant de déplacer les cartes entre les colonnes de manière interactive.",
            project9Title: "Projet d'Accessibilité",
            project9Desc: "Étude et application des pratiques d'accessibilité web (WCAG) pour garantir une navigation inclusive pour tous.",
